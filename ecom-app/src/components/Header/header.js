...
function Header() {
  return (
    <VStack
      as="header"
      bgImage="url(https://instantsearchjs.netlify.app/examples/react/e-commerce/cover.bc59a785.png)"
      minH="368px"
      bgSize="cover"
      bgPos="50%"
      justify="center"
    ...
    >
      <Box>
        <Link href="#">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 117" width="92">
            <path
              fill="#FFF"
      ...
      <Heading fontSize={38} fontWeight={300} color="white" pt="30px" pb="30px">
